...
public class ServerWorker extends Thread {
    ...
    public ServerWorker(Socket socket, OrderService orderService, DoneOrderService doneorderService) throws IOException {
        this.socket = socket;
